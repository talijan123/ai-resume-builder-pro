      ...
      <main className="flex-1 pt-28 pb-20">
        <Container>
          ...
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-400">
            ...
            <span>/</span>
            <span className="text-slate-200 font-semibold">Blog & Guides</span>
          </div>

          {/* Hero Header */}
          <div className="max-w-3xl mb-12">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-1.5 text-xs font-bold text-blue-400 uppercase tracking-widest mb-4">
          ...
          <div className="flex flex-col md:flex-row gap-5 items-stretch md:items-center justify-between mb-12 pb-8 border-b border-slate-800">
            {/* Search Input */}
            <div className="relative w-full md:max-w-md">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-slate-800 bg-slate-900/90 pl-11 pr-4 py-3 text-sm text-white placeholder-slate-500 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
              />
            </div>
          ...
          {!searchQuery && selectedCategory === "All" && featuredPost && (
            <div className="mb-16">
              <span className="text-xs font-black uppercase tracking-[0.2em] text-blue-400 mb-3 block">
                Featured Article
              </span>
              <div className="group relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/90 shadow-2xl transition-all duration-300 hover:border-blue-500/50 hover:shadow-blue-500/10">
                <div className="grid lg:grid-cols-12 gap-8 items-center p-6 sm:p-10">
                  <div className="lg:col-span-7 space-y-4">
                    ...
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white group-hover:text-blue-400 transition">
            ...
            {filteredPosts.length > 0 ? (
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {filteredPosts.map((post) => (
                  <article
                    key={post.id}
                    className="group flex flex-col justify-between overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/70 transition-all duration-300 hover:-translate-y-1.5 hover:border-blue-500/40 hover:bg-slate-900 hover:shadow-xl hover:shadow-blue-500/10"
                  >
                    {/* Cover Thumbnail */}
                    <Link
                      to={`/blog/${post.slug}`}
                      className="relative block h-48 overflow-hidden bg-slate-800"
                    >
                      <img
                        src={post.coverImage}
                        alt={post.title}
                      ...
                      />
                      <span className="absolute left-4 top-4 rounded-full bg-slate-950/80 backdrop-blur px-3 py-1 text-xs font-bold text-blue-300 border border-slate-700/50">
                        {post.category}
                      </span>
                    </Link>
                    ...
                    <div className="flex flex-1 flex-col justify-between p-6">
                      <div>
                        ...
                        <h3 className="text-lg font-bold text-white transition group-hover:text-blue-400 line-clamp-2">
                      ...
                      <div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center justify-between">
                        ...
                        <Link
                          to={`/blog/${post.slug}`}
                          className="text-xs font-bold text-blue-400 flex items-center gap-1 group-hover:translate-x-1 transition-transform"
                        >
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-600 p-8 sm:p-12 text-center text-white shadow-2xl">
            ...
            <button
              ...
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 text-sm font-bold text-blue-700 shadow-xl transition hover:scale-105"
            >
